            ...
            <form action="{{ route('barbershops.updateMy') }}" method="POST" enctype="multipart/form-data" class="barbershop-edit-card">
                ...
                <div class="barbershop-edit-section">
                    <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                        <a href="{{ route('barbershops.schedule.edit') }}" class="inline-flex min-h-12 items-center justify-center rounded-xl border border-gray-300 px-6 py-3 text-sm font-bold text-gray-700 transition hover:bg-gray-100">
                            Modificar horario
                        </a>
