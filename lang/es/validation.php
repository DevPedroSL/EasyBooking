...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas líneas contienen los mensajes de error predeterminados que usa el
    | validador de Laravel. Algunas reglas tienen varias versiones según tipo.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute aparece en una filtración de datos. Elige un valor diferente.',
    ],
    ...
    */
    ...
    'attributes' => [
        'address' => 'dirección',
        'avatar' => 'avatar',
        'barber_comment' => 'comentario del barbero',
        ...
        'phone' => 'teléfono',
        'remove_gallery_images' => 'imágenes a eliminar',
        'remove_image' => 'eliminar imagen',
        'schedule_days' => 'días de apertura',
        'slot_interval_minutes' => 'duración de los turnos',
